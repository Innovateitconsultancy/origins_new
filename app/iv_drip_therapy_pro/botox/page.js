...
export const metadata = {
    title: 'Botox — The Art of Ageless Expression',
    description: 'Botox — The Art of Ageless Expression',
};
...
export default function botox() {
    return (
        <>
           ...
           <h1> Botox — The Art of Ageless Expression
</h1>
           <h2><i>$</i>299</h2>
...
Chloride, Magnesium Chloride, Sodium Lactate, Hyaluronic Acid.
                                            ...
                                            <Link href="iv_drip_therapy_pro" className="theme-btn-new mt-3">
